...
int main() {
 ...
 cout << "Введите коэффицент c" << endl;
  cin >> c;
 if (((((a == 0)&&(!((a == 0)&&(b == 0)&&(c == 0)))))&&(!((a == 0)&&(b == 0))))&&(!(((a == 0))&&(c == 0)))) {
   x = -(c / b);
   cout << "х равен " << x << endl;
  }
 if (((b == 0) && (!((a == 0) && (b == 0) && (c == 0)))) && (!((a == 0) && (b == 0)))) {
   if (c < 0) {
     x1 = sqrt(-(c / a));
     x2 = -sqrt(-(c / a));
 ...
 if (((c == 0)&&(!((a == 0)&&(b == 0)&&(c == 0))))&&(!((b == 0)&&(c == 0)))&&(!((a == 0)&&(c == 0)))) {
   x1 = 0;
   x2 = - (b / a);
   cout << "Корни уравнения " << x1 << ", " << x2 << endl;
  }
 ...
 if ((((a == 0) && (c == 0)) || ((b == 0) && (c == 0))) && (!((a == 0) && (b == 0) && (c == 0)))) {
   x = 0;
   cout << "х равен " << x << endl;
  }
